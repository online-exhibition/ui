...
export const exhibitionsLoadSuccess =
    createAction(EXHIBITIONS_LOAD_SUCCESS, (items) => ({items}));
export const exhibitionsLoadFailure =
    createAction(EXHIBITIONS_LOAD_FAILURE, (error) => ({error}));
